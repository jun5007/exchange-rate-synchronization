...
- 형태: 팀 프로젝트 / 논문 형식 결과물
- 참여: 공동 연구자
- GitHub Portfolio: [jun5007.github.io](https://jun5007.github.io)
...
- Lift 기반 파트너 산업을 먼저 정의하고, 이후 월별 상관 구조를 반영하는 방식으로 동조성을 모델 입력 변수로 만들 수 있었습니다.
...
현재 저장소에는 공개 가능한 프로젝트 설명을 먼저 정리했습니다. 원본 데이터, 보고서, 코드 파일은 공개 범위 확인 후 추가할 예정입니다.
